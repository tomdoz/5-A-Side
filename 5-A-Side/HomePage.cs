...
namespace _5_A_Side
{
    public partial class HomePage : Form
    {
        ...
        private void resetButton_Click(object sender, EventArgs e)
        {
            ...
            Com.CommandText = "Update UserTable SET UserWins = " + 0 + ", UserDraws = " + 0 + ", UserLosses = " + 0 + ", UserGF = " + 0 + ", UserGA = " + 0 + ", UserPoints = " + 0 + ", UserMatches = " + 0 + ", MUWins = " + 0 + ", MUDraws = " + 0 + ", MULosses = " + 0 + ", MUGF = " + 0 + ", MUGA = " + 0 + ", MUPoints = " + 0 + ", MUMatches = " + 0 + ", CHEWins = " + 0 + ", CHEDraws = " + 0 + ", CHELosses = " + 0 + ", CHEGF = " + 0 + ", CHEGA = " + 0 + ", CHEPoints = " + 0 + ", CHEMatches = " + 0 + ", WOLWins = " + 0 + ", WOLDraws = " + 0 + ", WOLLosses = " + 0 + ", WOLGF = " + 0 + ", WOLGA = " + 0 + ", WOLPoints = " + 0 + ", WOLMatches = " + 0 + ", SOUWins = " + 0 + ", SOUDraws = " + 0 + ", SOULosses = " + 0 + ", SOUGF = " + 0 + ", SOUGA = " + 0 + ", SOUPoints = " + 0 + ", SOUMatches = " + 0 + ", NORWins = " + 0 + ", NORDraws = " + 0 + ", NORLosses = " + 0 + ", NORGF = " + 0 + ", NORGA = " + 0 + ", NORPoints = " + 0 + ", NORMatches = " + 0; //update all records in the Teams table, to have 0 in all the columns that allow progress
            Com.Connection = Con;
